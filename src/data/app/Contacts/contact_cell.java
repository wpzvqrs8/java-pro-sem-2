...
public class contact_cell{
    ...
    String get_random_hex(){
        ...
        String[] fx_colors = {"red","green","blue","gray","grey","yellow","orange","purple","pink","cyan","magenta","gold","goldenrod","coral","crimson","indigo","violet","navy","teal","olive","lime","salmon","tomato","turquoise","skyblue","royalblue","steelblue","dodgerblue","deepskyblue","lightblue","lightgreen","forestgreen","seagreen","springgreen","khaki","wheat","chocolate","sienna","maroon","plum","orchid","lavender"};
