...
//        Main.prev = (AnchorPane) main_contact_frame;
        ...
        if (source == name) {
            ...
            //phone number
            new_contact.phoneNumber = ((TextField)source).getText();
        ...
        String new_contact_query = "INSERT INTO contacts(id,name,phone_number,email,category,address,company,notes,favorite) VALUES(?,?,?,?,?,?,?,?,?)";
        PreparedStatement statement = conn.prepareStatement(new_contact_query);
        statement.setInt(1,new_contact.id);
        statement.setString(2,new_contact.name);
        statement.setString(3,new_contact.phoneNumber);
        statement.setString(4,new_contact.email);
        statement.setString(5,new_contact.category);
        statement.setString(6,new_contact.address);
        statement.setString(7,new_contact.company);
        statement.setString(8,new_contact.notes);
        statement.setBoolean(9,new_contact.favorite);
